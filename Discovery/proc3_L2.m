...
%             if stfnbasercmp(flds{ifld}, "time")
%                 continue
%             endif
...
# 
#    # Calculate likely clear sky Es from Gregg and Carder, plus ratio of direct:diffuse
...
#          ksun0 = 3.14; # Point sensor from GordDATESTRon and Ding 1992 as per Mueller 2003 
...
# Iteratively estimate chl and retrieve fQ values or use L2.chl to extract fQ
